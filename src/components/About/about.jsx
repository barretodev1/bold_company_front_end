    ...
    return (
        ...
        <section id='sobre' className='p-16'>
            ...
            <div className='flex flex-col gap-10 items-center mt-16 justify-center md:flex-row'>
                <div className='meu-about hover:translate-x-0 w-80 md:w-2/3 hover:-translate-x-2 transition-all flex items-center justify-center flex-col border bg-zinc-400 h-80 rounded-2xl p-4'>                    
