...
export function About() {
    ...
    return (
        ...
        <section id='sobre'>
            <figure className='flex items-center justify-center p-10'>
            ...
            <div className='flex flex-col gap-10 items-center mt-6 justify-center md:flex-row'>
                ...
                <div className='meu-about hover:-translate-y-0 md:hover:-translate-y-2 transition-all flex items-center justify-center flex-col border bg-zinc-400 h-80 w-64 rounded-2xl p-4'>
                    <h1 className='sticky top-0 bg-zinc-400 p-2 z-10'>VISÃO</h1>
