    ...
    return (
        ...
        <section id='sobre' className='p-16'>
            ...
            <div className='flex flex-col gap-10 items-center mt-16 justify-center md:flex-row'>
                <div className='meu-about flex w-2/3 h-96 hover:translate-x-0 md:hover:-translate-x-2 transition-all items-center justify-center flex-col border bg-zinc-400 h-80 rounded-2xl p-4'>
                ...
                <div className='meu-about flex w-2/3 h-96 hover:-translate-y-0 md:hover:-translate-y-2 transition-all flex items-center justify-center flex-col border bg-zinc-400 h-80 w-64 rounded-2xl p-4'>
                ...
                <div className='meu-about flex w-2/3 h-96 hover:translate-x-0 md:hover:translate-x-2 transition-all flex items-center justify-center flex-col border bg-zinc-400 h-80 w-64 rounded-2xl p-4'>
                    <div>
