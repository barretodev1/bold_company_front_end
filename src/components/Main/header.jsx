...
=======
                        <li className='minha-li text-black hover:text-purple-800 transition'><a href="#home">Home</a></li>
                        <li className='minha-li text-black hover:text-purple-800 transition'><a href="#sobre">Sobre</a></li>
>>>>>>> 4259c40 (feat: ABOUT READY)
...
=======
            <main id='home' class="meu-main flex flex-col justify-center">
                <div className='ml-7 md: ml-3'>
                    <h1 className='meu-h1'>QUER TRANSFORMAR SUA EMPRESA?</h1>
                    <h2 className='meu-h2 mt-3 hidden md:block'>A BOLD chegou aquecida no mercado, justamente<br></br> para isto, para resolver seu problema de uma forma<br></br> eficiente e didática, pra que você decole.<br></br>Então entre em contato conosco <span className='font-bold text-purple-300'>AGORA</span>!</h2>
                    <h2 className='meu-h2-mob mt-3 md:hidden'>A BOLD chegou aquecida no mercado, justamente para isto, para resolver seu problema de uma forma eficiente e<br></br> didática, pra que você decole.<br></br>Então entre em contato conosco <span className='font-bold text-purple-300'>AGORA!</span></h2>
>>>>>>> 4259c40 (feat: ABOUT READY)
                </div>
